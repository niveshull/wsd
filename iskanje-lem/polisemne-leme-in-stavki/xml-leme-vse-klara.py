...
with open('../zmanjsevanje-inventarja-polisemnih-lem/polisemne_klara.txt', 'r', encoding='utf-8') as f:
    polysemous_lemmas = set([line.strip() for line in f.readlines()])

stavki_s_polisemi = []

with open('seznam-polisemnih-klara.csv', 'w', newline='', encoding='utf-8-sig') as csvfile:
