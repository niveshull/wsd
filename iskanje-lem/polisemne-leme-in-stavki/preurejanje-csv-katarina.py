...
with open('seznam-polisemnih-katarina.csv', 'r', encoding="utf-8-sig") as infile, open('seznam-polisemnih-urejeno-katarina.csv', 'w', newline='', encoding="utf-8") as outfile:
