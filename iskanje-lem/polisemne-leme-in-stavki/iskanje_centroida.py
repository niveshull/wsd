...
with open('seznam-polisemnih-urejeno-klara.csv', 'r', encoding='utf-8') as input_file:
...
with open('centroidi_klara.txt', 'w', encoding='utf-8') as output_file:
